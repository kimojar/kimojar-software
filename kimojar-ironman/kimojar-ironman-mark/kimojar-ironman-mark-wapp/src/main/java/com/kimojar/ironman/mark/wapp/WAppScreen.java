...
public class WAppScreen extends JPanel {
	...
	private JPanel layoutBaseInfomationPanel() {
		...
		categoryComboBox.setRenderer(Listener.categoryComboxBoxRender());
		categoryComboBox.setSelectedItem(null);
		categoryComboBox.addMouseListener(Listener.appDetialTextFieldMouseExitedListener());
		categoryComboBox.addItemListener(Listener.categoryComboBoxItemListener());
		// app directory
	...
	private JPanel layoutCommandInformationPanel() {
		...
		JPanel cmdActionPanel = new JPanel();
		cmdActionPanel.setLayout(new FlowLayout(FlowLayout.LEADING));
		JLabel cmdActionLabel = new JLabel();
		ComponentDict.record(WAppI18N.JLabel_CmdAction, cmdActionLabel);
		cmdActionLabel.setText(WAppI18N.JLabel_CmdAction.i18n());
		cmdActionPanel.add(cmdActionLabel);
		JButton cmdActionButton = new JButton();
		ComponentDict.record(WAppI18N.JButton_CmdAction, cmdActionButton);
		cmdActionButton.setText(WAppI18N.JButton_CmdAction.i18n());
		cmdActionButton.addMouseListener(Listener.cmdActionButtonClicked());
		cmdActionPanel.add(cmdActionButton);
		gbc.gridx = 1;
		gbc.gridy = 0;
		gbc.gridwidth = 1;
		gbc.gridheight = 1;
		gbc.weightx = 0;
		gbc.weighty = 0;
		gbl.setConstraints(cmdInfoPanel.add(cmdActionPanel), gbc);
